...
export default function page() {
  ...
  return (
    <section className={`${styles.videoDatabase}`}>
      {/* Container */}
      <div>
        {/* Tabs */}
      ...
      <div className={`flex flex-col gap-[0.7vw] w-full pageHeader my-[25px]`}>
        <div className="flex justify-between items-end">
          <div className={`${styles.videoDatabasePage} w-8/12 flex gap-[1vw]`}>
            <div className="flex flex-col w-1/4 gap-[0.3vw]">
              <h5>Product Type</h5>
              <CustomSelectInput label="All" options={productTypeOptions} />
            </div>
            <div className="flex flex-col w-[25%] gap-[0.3vw]">
              <h5>Demand</h5>
              <div className={`${styles.changeOrder} `} onClick={() => { setDemandOrder(!demandOrder) }}>
            ...
            <div className="flex flex-col w-[25%] gap-[0.3vw]">
              <h5>Last Bought</h5>
              <div className={`${styles.changeOrder} `} onClick={() => { setLastBoughtOrder(!lastBoughtOrder) }}>
...
{/* BUTTON MODALS HERE */}
          <div className="flex gap-2">
            ...
            <AddNewProductModal btnWord={'New Entry'} btnIcon={<svg xmlns="http://www.w3.org/2000/svg" width="11" height="11" viewBox="0 0 11 11" fill="none">
            ...
            </svg>} btnColor={'black'} modalTitle={'Add New Product'} />
        ...
        {/* Tab 2 Content */}
        {activeTab === 2 && (
          <div className={`${styles.tab2}`}>      {/* filters options to filter and edit data in table */}      
          <div className={`flex flex-col gap-[0.7vw] w-full pageHeader my-[25px]`}>
            <div className="flex justify-between items-end">
              <div className={`${styles.videoDatabasePage} w-8/12 flex gap-[1vw]`}>
                <div className="flex flex-col w-1/4 gap-[0.3vw]">
    ...
    {/* BUTTON MODALS HERE */}
            ...
            <UploadReceiptModal btnWord={'Upload Receipts'} btnColor={'black'} modalTitle={'Upload Receipt'} />
