...
const layout = ({ children }: Readonly<{ children: React.ReactNode; }>) => {
  ...
  const sideNavLinks = [
    {
      name: "Dashboard", path: "/administrative/dashboard", icon: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="none">
    ...
    {
      name: "Office Maintenance", path: "/administrative/office-maintenance", icon: <svg xmlns="http://www.w3.org/2000/svg" width="20" height="27" viewBox="0 0 20 27" fill="none">
      <path d="M16.4681 2.55047H14.3409H14.2787C13.6571 1.05454 12.189 0 10.4675 0C8.7467 0 7.27928 1.05649 6.65576 2.55047H6.59224H4.46566C3.6801 2.55047 3.04297 3.06835 3.04297 3.70613C3.04297 4.3452 3.04297 4.86178 3.04297 4.86178H17.8902V3.70613C17.8908 3.06835 17.2537 2.55047 16.4681 2.55047ZM10.4669 3.79557C9.82846 3.79557 9.31124 3.27835 9.31124 2.63992C9.31124 2.00214 9.82846 1.48362 10.4669 1.48362C11.1053 1.48362 11.6225 2.00214 11.6225 2.63992C11.6232 3.27835 11.1053 3.79557 10.4669 3.79557Z" fill="#2A2B2A"/>
      <path d="M0 6.96831V26.969H17.4191C18.8443 26.969 20 25.8133 20 24.388V4.38672H19.0667V6.03173H1.90816V4.48718C0.810837 4.78468 0 5.77636 0 6.96831ZM2.32492 11.471C2.32492 10.8643 2.96205 10.375 3.74761 10.375H17.8903C17.8903 10.375 17.8903 10.865 17.8903 11.471C17.8903 12.0777 17.2538 12.5683 16.4682 12.5683H2.32557C2.32557 12.5683 2.32492 12.0777 2.32492 11.471ZM2.21732 14.9075C2.21732 14.1207 2.85381 13.4848 3.63937 13.4848H17.7827V16.4482C17.7827 17.2344 17.1455 17.8702 16.36 17.8702H2.21732V14.9075Z" fill="#2A2B2A"/>
    </svg>
    },
    {
      name: "Ticketing", path: "/administrative/ticketing", icon: <svg xmlns="http://www.w3.org/2000/svg" width="25" height="15" viewBox="0 0 25 15" fill="none">
    ...
    {
      name: "Database", path: "/administrative/video-database", icon: <svg xmlns="http://www.w3.org/2000/svg" width="20" height="28" viewBox="0 0 20 28" fill="none">
      <path d="M0 0H20V3.5H0V0ZM1.36364 4.9V28H18.6364V4.9H1.36364ZM13.1818 11.2H6.36364V9.1H13.1818V11.2Z" fill="#FFFFFB"/>
    </svg>
    }
  ]
