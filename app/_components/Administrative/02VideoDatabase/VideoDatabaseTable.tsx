...
export default function VideoDatabaseTable() {
   ...
   const headRow = [
    {
        ...
        <path d="M0 3.33301H17.7778C19.0051 3.33301 20 4.32793 20 5.55523H0V3.33301Z" fill="#2A2B2A"/>
        <path d="M0 7.77734H20V12.444C20 14.3109 20 15.2442 19.6367 15.9573C19.3171 16.5846 18.8072 17.0945 18.18 17.414C17.4669 17.7773 16.5336 17.7773 14.6667 17.7773H5.33333C3.46649 17.7773 2.53307 17.7773 1.82003 17.414C1.19282 17.0945 0.682889 16.5846 0.363311 15.9573C1.32455e-07 15.2442 0 14.3109 0 12.444V7.77734Z" fill="#2A2B2A"/>
        <path d="M0 3.33333C0 2.29791 4.96705e-08 1.7802 0.169156 1.37181C0.3947 0.827311 0.827311 0.3947 1.37181 0.169155C1.7802 -2.15239e-07 2.29791 0 3.33333 0H5.93683C6.84517 0 7.29933 -2.15239e-07 7.70771 0.169155C8.11611 0.338311 8.43722 0.659455 9.07956 1.30174L11.1111 3.33333H0Z" fill="#2A2B2A"/>
            </svg>
        )
    },
    {
   ...
   const bodyRow = [
    { product: "Chips", type: "Snacks", price: 2.5, demand: 150, lastBought: "2023-05-17" },
    { product: "Toilet Paper", type: "Cleaning", price: 8.99, demand: 80, lastBought: "2023-04-20" },
    { product: "Cotte Nescafe", type: "Drinks", price: 12.75, demand: 40, lastBought: "2023-05-12" },
    { product: "Choco Mix", type: "Snacks", price: 3.49, demand: 120, lastBought: "2023-05-05" },
    { product: "Air Fresh", type: "Cleaning", price: 14.49, demand: 60, lastBought: "2023-05-15" },
    { product: "Suger", type: "Snacks", price: 1.99, demand: 200, lastBought: "2023-05-10" },
    { product: "V Cola", type: "Drinks", price: 1.25, demand: 250, lastBought: "2023-05-08" },
    { product: "Fox Chips Salt", type: "Snacks", price: 4.99, demand: 100, lastBought: "2023-05-18" },
    { product: "Big Chips Truffle", type: "Snacks", price: 5.99, demand: 70, lastBought: "2023-05-14" },
    { product: "Tea Lipton", type: "Drinks", price: 6.25, demand: 90, lastBought: "2023-05-11" },
    { product: "Green Tea Ahmed Tea", type: "Drinks", price: 5.75, demand: 110, lastBought: "2023-05-16" },
    { product: "McVitties", type: "Snacks", price: 3.75, demand: 140, lastBought: "2023-05-13" }
];
  ...
  <table className="w-full text-sm text-gray-500 text-center">
    <thead className="bg-gray-50 text-xs text-gray-700 border-b border-black">
      <tr>
        {
            headRow.map((e,i)=>{
                return <th key={i} scope="col" className="px-6 py-3">
    ...
    <tbody>
        ...
        return(
            ...
            <td key={i} className="px-6 py-4">{e.product}</td>
            <td key={i} className={`${styles.e.type}`}>{e.type}</td>
            <td key={i} className="px-6 py-4">{e.price}</td>
            <td key={i} className="px-6 py-4">{e.demand}</td>
            <td key={i} className="px-6 py-4">{e.lastBought}</td>
            </tr>
        )
        })}
