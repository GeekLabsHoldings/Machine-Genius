</svg>
...
<path d="M9.09889 11.2856L10.6333 20H1.11111C0.497778 20 0 19.5022 0 18.8889V12.8911L9.09889 11.2856ZM18.8889 0C19.5022 0 20 0.497778 20 1.11111V18.8889C20 19.5022 19.5022 20 18.8889 20H12.8911L9.36445 0H18.8889ZM7.10778 0L8.71222 9.09778L0 10.6333V1.11111C0 0.497778 0.497778 0 1.11111 0H7.10778Z" fill="#2A2B2A"/>
    ...
    },
    {
      ...
      icon: (
        <svg width="20" height="18" viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M3.125 5.85938H0.78125C0.349766 5.85938 0 6.20914 0 6.64062V16.4062C0 16.8377 0.349766 17.1875 0.78125 17.1875H3.125C3.55648 17.1875 3.90625 16.8377 3.90625 16.4062V6.64062C3.90625 6.20914 3.55648 5.85938 3.125 5.85938Z" fill="#2A2B2A"/>
<path d="M13.1694 5.85938C12.5679 5.85938 12.1832 5.21832 12.4663 4.6875L13.8895 2.01902C14.3772 1.10449 13.7145 0 12.6781 0C12.3139 0 11.9648 0.144648 11.7073 0.402109L7.16527 4.9441C6.57926 5.53016 6.25 6.325 6.25 7.15379V14.0625C6.25 15.7884 7.6491 17.1875 9.375 17.1875H15.8455C16.912 17.1875 17.8441 16.4674 18.1133 15.4354L19.9327 8.46098C19.9774 8.28977 20 8.11355 20 7.93664C20 6.78941 19.07 5.85938 17.9227 5.85938H13.1694Z" fill="#2A2B2A"/>
</svg>
  ...
  return (
    <>
      <div className={`${styles.listDetails} pt-[1.5vw] w-full`}>
        <div className=" flex items-center gap-[0.6vw] w-fit mb-[2.3vw]">
          <svg
            width="11"
            height="22"
            viewBox="0 0 11 22"
        ...
        <div className=" mb-[1.5vw] flex items-center justify-between">
          ...
          <div>
                ...
                <div className="border-[var(--dark)] border-[1px] rounded-md flex justify-between items-center px-[0.677vw] w-[11.927vw] py-[0.2vw]">
                  <span>{sorting}</span>
                  <svg
                    onClick={() => {
                      sorting == "Ascend"
        ...
        <div
            ...
            >
              ...
              <div className={`${styles.tableHead} w-full `}>
                <ul className="flex justify-between items-center border-b-2 border-b-[var(--dark)] w-fit min-w-full">
                  ...
                  {headEmailList.map((e, i) => (
                    ...
                    <li className={`w-[14.28%] min-w-[215px]`} key={i}>
                      {e.icon}
                      {e.name}
                    </li>
                  ))}
              ...
              <div
                className={`${styles.tableBody}  overflow-y-scroll rounded-xl h-[53vh] w-fit `}
              >
                ...
                {emailLists.map((e, i) => (
                  ...
                  >
                    {/* emailAddress column */}
                    <li className={`w-[14.28%] min-w-[215px]`}>
                      {e.emailAddress}
                    </li>
                    {/*Subscription column with specific background color */}
                    <li className={`w-[14.28%] min-w-[215px]`}>
                      <span className="p-2 rounded-sm bg-[#E1C655B2] ">{e.Subscription}</span>
                    </li>
                    {/* Space column */}
                    <li
                      className={`w-[14.28%] min-w-[215px]`}
                     
                    >
                     <span className="p-2 rounded-sm bg-[#E9313EB2] text-white"  >{e.Source}</span>
                    </li>
                    {/* Brand column with specific background color */}

                    <li className={`w-[14.28%] min-w-[215px] `}>
                    <span className="p-2 rounded-sm bg-[#E1C655B2] ">{e.Brand}</span>
                    </li>
                    {/* Ratings column */}
                    <li className={`w-[14.28%] min-w-[215px]`}>
                    ...
                    {/* Date column */}
                    <li className={`w-[14.28%] min-w-[215px]`}>{e.dateAdded}</li>
                    {/* Niche column */}

                    <li className={`w-[14.28%] min-w-[215px]`}>{e.Niche}</li>
                  </ul>
                ))}
              </div>
            </div>
