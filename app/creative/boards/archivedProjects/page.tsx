...
const Page = () => {
  ...
  return (
    <div className={`${styles.archived} mt-[4.6vh] `}>
      {/* Heading for archived projects */}
      <h3
        onClick={() => {
          router.back();
        }}
        className={`${styles.heading} mb-[1.892vw] cursor-pointer`}
      >
        Archived Projects
      </h3>
            ...
            <div className={`py-3 pr-[1.25vw] ${styles.sliderCard}`} key={i}>
              ...
              >
                <div className="mb-[--sy-26px] flex items-center">
                  <h3 className="!ml-0 pr-[0.662vw] !text-[--20px]">
                    {e.name}
                  </h3>
