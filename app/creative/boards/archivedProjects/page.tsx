  ...
  return (
    <>
      ...
      <div className={`${styles.archived} mt-[4.6vh] `}>
        ...
        <h3 onClick={()=>{
          router.back() 
        }} className={`${styles.heading} mb-[1.892vw] cursor-pointer`}>Archived Projects</h3>
        ...
        <div className="slider-containerpy-[1.67vh]">
          <Slider {...settings}>
            {/* Mapping archived projects */}
            {project.map((e, i) => (
              <div className={`pe-[1.25vw] ${styles.sliderCard} py-3`} key={i}>
                <div className={`mb-[0.6vw] ${styles.cards} p-4 rounded-3xl`}>
                  ...
                  >
                    {e.icon} <p className="font-medium">{e.state}</p>
                  </div>
                </div>
                <span
