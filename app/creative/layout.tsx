...
const layout = ({ children }: Readonly<{ children: React.ReactNode; }>) => {
  ...
  const sideNavLinks = [
    {
      name: "Dashboard", path: "/creative/dashboard", icon: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="none">
    ...
    {
      name: "Boards", path: "/creative/boards", icon: <svg xmlns="http://www.w3.org/2000/svg" width="22" height="21" viewBox="0 0 22 21" fill="none">
    ...
    {
      name: "Calendar", path: "/creative/calender", icon: <svg xmlns="http://www.w3.org/2000/svg" width="22" height="21" viewBox="0 0 22 21" fill="none">
    ...
    {
      name: "Handover", path: "/creative/handover", icon: <svg xmlns="http://www.w3.org/2000/svg" width="22" height="21" viewBox="0 0 22 21" fill="none">
