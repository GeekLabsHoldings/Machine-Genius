...
import { ApprovalStatus, ArticleNames, Brands, ContentType } from '@/app/data/data';

const ArticleDatabase = ()=>{
   
    return(
        <div className="flex flex-col gap-[1vw]">
        <div className={`${styles.articleDatabase} flex flex-col justify-center items-center h-[80vh] w-full gap-[1vw] `}>
            ...
            <div className={`${styles.filters} flex justify-between`}>
                ...
                <div className="flex flex-col w-2/12 gap-[0.3vw]">
                    <h5>Content Type</h5>
                    <CustomSelectInput label='All' options={ContentType}/>
                </div>
                <div className="flex flex-col w-2/12 gap-[0.3vw]">
                    <h5>Approvals</h5>
            ...
            <div className={`${styles.box} w-full px-[0.5vw]`}>
                        <div >
                        <ul className={`${styles.tableHeader} flex justify-center items-center py-[2vh]`}>
                        ...
                        <ul className={`${styles.tableBody} flex justify-center items-center py-[0.2vh]`}>
                        <li className='w-[4vw]'>1</li>
                            <li className='w-[20vw]'>Pacific Allies ABANDON USA For China!</li>
                            <li className='w-[15vw]'><span className='bg-[#31B2E9B2] '>PST USA</span></li>
                            <li  className='w-[10vw]'>
                            ...
                            <li className='w-[10vw] '>Pending</li>
                            <li className='w-[15vw] '>12 March  2024</li>
                            <li className={`w-[6vw] ${styles.edit}`}><a href="#">Edit</a></li>

                        </ul>

                        <ul className={`${styles.tableBody} flex justify-center items-center py-[0.2vh]`}>
                        <li className='w-[4vw]'>2</li>
                            <li className='w-[20vw]'>Pacific Allies ABANDON USA For China!</li>
                            <li className='w-[15vw]'><span className='bg-[#E1C655B2]'>PST Asia</span></li>
                            <li  className='w-[10vw]'>
                                <ul style={{listStyle:'inside'}}>
                                    <li>Script</li>
                                    <li>Article</li>
                        ...
                        <ul className={`${styles.tableBody} flex justify-center items-center py-[0.2vh]`}>
                        <li className='w-[4vw]'>3</li>
                            <li className='w-[20vw]'>Pacific Allies ABANDON USA For China!</li>
                            <li className='w-[15vw]'>Investocracy</li>
                            <li  className='w-[10vw]'>
                                <ul style={{listStyle:'inside'}}>
                                    <li>Script</li>
                                    <li>Article</li>
                            ...
                            <li className='w-[10vw] '>Rejected</li>
                            <li className='w-[15vw] '>12 March  2024</li>
                            <li className={`w-[6vw] ${styles.edit}`}><a href="#">Edit</a></li>
                        ...
                        <li className='w-[4vw]'>4</li>
                            ...
                            <li className='w-[10vw] '>Approved</li>
                            <li className='w-[15vw] '>12 March  2024</li>
                            <li className={`w-[6vw] ${styles.edit}`}><a href="#">Edit</a></li>
                        ...
                        <ul className={`${styles.tableBody} flex justify-center items-center py-[0.2vh]`}>
                        <li className='w-[4vw]'>5</li>
                            <li className='w-[20vw]'>Pacific Allies ABANDON USA For China!</li>
                            <li className='w-[15vw]'>Street Politics</li>
                            <li  className='w-[10vw]'>
                                <ul style={{listStyle:'inside'}}>
                                    <li>Script</li>
                                    <li>Article</li>
                        ...
                        <ul className={`${styles.tableBody} flex justify-center items-center py-[0.2vh]`}>
                        <li className='w-[4vw]'>6</li>
                            <li className='w-[20vw]'>Pacific Allies ABANDON USA For China!</li>
                            <li className='w-[15vw]'>PST Asia</li>
                            <li  className='w-[10vw]'>
                                <ul style={{listStyle:'inside'}}>
                                    <li>Script</li>
                                    <li>Article</li>
                        ...
                        <ul className={`${styles.tableBody} flex justify-center items-center py-[0.2vh]`}>
                        <li className='w-[4vw]'>8</li>
                            <li className='w-[20vw]'>Pacific Allies ABANDON USA For China!</li>
                            <li className='w-[15vw]'>Canada</li>
                            <li  className='w-[10vw]'>
                                <ul style={{listStyle:'inside'}}>
                                    <li>Script</li>
                                    <li>Article</li>
