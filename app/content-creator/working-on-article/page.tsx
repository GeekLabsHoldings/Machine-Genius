...
import styles from './working-onarticle.module.css'

const WorkingOnArticle = () => {
    return (
        <div className="flex flex-col h-full">

            <div className="flex flex-col justify-center items-center w-[30vw] min-w-[24rem] m-auto h-full ">
                <div className={styles.loading_logo}>
                    ...
                    <h6>Genius is working on your article..</h6>
                    <p>Hold on tight.</p>
                </div>
            </div>
