                    ...
                    <div className="w-full flex">
                        <div className="w-1/2 flex flex-col  gap-[1.5vw]">
                            ...
                            <div className="w-11/12 mx-auto flex flex-col gap-[0.8vw] ">
                                ...
                                <div className={`${styles.imgWrapper} flex justify-center items-center overflow-hidden h-[15vh] relative`}>
                                    ...
                                    <input type="file" id='first-img' name='article-image' className={styles.inputImg} onChange={(e) => { handleImageChange(e) }} />
                                    <img src="" alt="" />
                                </div>
                            ...
                            <div className="w-11/12 mx-auto flex flex-col gap-[0.8vw] ">
                                <div className={`${styles.imgWrapper} flex justify-center items-center overflow-hidden h-[15vh] `}>
                                    ...
                                    <input type="file" id='second-img' name='article-image' onChange={(e) => { handleImageChange(e) }} />
                                    <img src="" alt="" />
                                </div>
                            ...
                            <div className="w-11/12 mx-auto flex flex-col gap-[0.8vw]">
                                <div className={`${styles.imgWrapper} flex justify-center items-center overflow-hidden h-[15vh] `}>
                                    ...
                                    <input type="file" id='third-img' name='article-image' onChange={(e) => { handleImageChange(e) }} />
                                    <img src="" alt="" />
                                </div>
                        ...
                        <div className="w-1/2 flex flex-col gap-[1.5vw]">
                            <div className="w-11/12 mx-auto flex flex-col gap-[0.8vw]">
                                <div className={`${styles.imgWrapper} flex justify-center items-center overflow-hidden h-[15vh] `}>
                                    ...
                                    <input type="file" id='forth-img' name='article-image' onChange={(e) => { handleImageChange(e) }} />
                                    <img src="" alt="" />
                                </div>
