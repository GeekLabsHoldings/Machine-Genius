          ...
          <div className="w-full flex">
            <div className="w-1/2 flex flex-col  gap-[1.5vw]">
                <div className="w-11/12 mx-auto flex flex-col gap-[0.8vw]">
                    <div className={`${styles.imgWrapper} h-[15vh] flex justify-center items-center`}>
                        <div>
                        <input type="file" id="article-image" onChange={(e)=>{handleImageChange(e); console.log(image)}} />
