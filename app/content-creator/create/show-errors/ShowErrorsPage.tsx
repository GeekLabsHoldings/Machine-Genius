  ...
  useEffect(() => {
    ...
    if (
      ...
      if (typeof window !== "undefined"){
        ...
        const checkGrammerResults = sessionStorage.getItem("checkGrammerResults");
              ...
              <div className={` ${styles.articlePreview} h-full`}>
                          <div className={`${styles.articlePreviewData} `}>
                            ...
                            <div
                              ...
                              // onInput={handleInput}
                            >
              {selectedIndex === null ? finalArticle?.articles[0]?.content :                               
              (
    <>
    "
    <p >{highlightText(finalArticle?.articles[0]?.content.replace(/[*#]/g, ""), selectedIndex.sentence_start, selectedIndex.sentence_start + selectedIndex.sentence.length)[0]}</p>
    <p className='bg-red-200'>{highlightText(finalArticle?.articles[0]?.content.replace(/[*#]/g, ""), selectedIndex.sentence_start, selectedIndex.sentence_start + selectedIndex.sentence.length)[1]}</p>
    <p>{highlightText(finalArticle?.articles[0]?.content.replace(/[*#]/g, ""), selectedIndex.sentence_start, selectedIndex.sentence_start + selectedIndex.sentence.length)[2]}</p>
    "
    </>
              )
              }
