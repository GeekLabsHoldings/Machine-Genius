    ...
    return (
        <div className="flex flex-col h-full">
            ...
            <div className="flex justify-between items-center">
                <CustomBtn word="Back" btnColor="white" href="/content-creator/create/create-article" />
                <CustomBtn word="Next" btnColor="black" href="/content-creator/create/final-article" />
            </div>
