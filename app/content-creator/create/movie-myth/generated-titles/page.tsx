  ...
  return (
    <div className="flex flex-col justify-between h-[90%]">
        ...
        <div className="flex justify-between">
            <CustomBtn word={"Back"} btnColor="white" href={"/content-creator/create/movie-myth/comments-on-article"} />
            <CustomBtn word={"Uploud Images"} btnColor="black" href={"/content-creator/create/movie-myth/images-generating-titles"} />
        </div>
    </div>
  )
}
