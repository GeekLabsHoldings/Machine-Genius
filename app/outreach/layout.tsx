...
const layout = ({ children }: Readonly<{ children: React.ReactNode; }>) => {
  ...
  const sideNavLinks = [
    {
      name: "Dashboard", path: "/outreach/dashboard", icon: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="none">
    ...
    {
      name: "Email Outreach", path: "/outreach/email-outreach", icon: <svg xmlns="http://www.w3.org/2000/svg" width="22" height="21" viewBox="0 0 22 21" fill="none">
    ...
    {
      name: "Social Media Outreach", path: "/outreach/social-media-outreach", icon: <svg xmlns="http://www.w3.org/2000/svg" width="22" height="21" viewBox="0 0 22 21" fill="none">
    ...
    {
      name: "Templates", path: "/outreach/templates", icon: <svg xmlns="http://www.w3.org/2000/svg" width="22" height="21" viewBox="0 0 22 21" fill="none">
    ...
    {
      name: "Campaigns", path: "/outreach/campaigns", icon: <svg xmlns="http://www.w3.org/2000/svg" width="22" height="21" viewBox="0 0 22 21" fill="none">
    ...
    {
      name: "Data Collection", path: "/outreach/data-collection", icon: <svg xmlns="http://www.w3.org/2000/svg" width="22" height="21" viewBox="0 0 22 21" fill="none">
