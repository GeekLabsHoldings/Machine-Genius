...
const SuggetionPosts = ['Stocks, the heartbeat of the marketStocks, the heartbeat of the market! ! Whether you are a seasoned investor or just getting started, understanding trends and staying informed is key to navigating this thrilling financial landscape.',
  'Whether you are a seasoned investor or just getting started, understanding trends and staying.',
        ...
        <div className="grid grid-cols-2 gap-[2vw] w-full h-full">
          ...
          <div className={styles.post_content + " flex flex-col justify-between"}>
            ...
            <div className={styles.suggestions + " space-y-[0.7vw]"}>
              ...
              {SuggetionPosts.map(ele => <div className={styles.item} onClick={() => setPostText(ele)}>
                <p>{ele}</p>
                <a href="">
          ...
          <div className={styles.post_view}>
            <div className={styles.post_view_screens + " flex gap-[1vw]"}>
              <div className={styles.desctop_screen + " w-2/3"}>
                <h6>Desktop View</h6>
                <div className={styles.desctop_iew}>
                  ...
                  <p>Stocks, the heartbeat of the market! Whether you're a seasoned investor or just getting started, understanding trends and staying informed is key to navigating this thrilling financial landscape.  #stockstoday</p>
                </div>
              </div>
              <div className={styles.mobile_screen + " w-1/3"}>
                <h6>Mobile View</h6>
                <div className={styles.mobile_iew}>
