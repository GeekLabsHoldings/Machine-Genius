                    ...
                    <div className="tab-content h-[75vh]">
                        <div className='py-[1.5vw] grid grid-cols-2 gap-[2vw] h-full'>
                            <div className='flex flex-col h-full'>
                                ...
                                <div className={styles.recent_notification + " h-[65vh] space-y-[1vw] overflow-y-auto"}>
                                    <div className={styles.item}>
                                        ...
                                        <p>Couldn’t be happier for my teammate <a href=''>@ReggieBush</a> and <a href="">@uscfb</a> Amazing player, even better person.</p>
                                    </div>
                            ...
                            <div className='flex flex-col justify-start h-full'>
                                <div className={styles.comments_suggestions + " space-y-[0.7vw]"}>
                                    <h6>Comments Suggestions</h6>
                                    {SuggetionPosts.map(ele => <div className={styles.item}>
                                        <p>{ele}</p>
                                        <a href="">
                                ...
                                <div className='h-full flex flex-col justify-between'>
                                    <div>
                                        ...
                                        <div className={styles.schadule_comment + " grid grid-cols-2 gap-[15%]"}>
                                            <div className={styles.time_range}>
                                                <p>Comments Time Range</p>
                                                <span>Best Time Range*</span>
                                    ...
                                    <CustomBtn btnColor='black' word='Post' style={{marginLeft: 'auto'}}/>
