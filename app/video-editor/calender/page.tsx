...
export default function Calendar() {
    ...
    const arrowLeft = <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6"> /* SVG path */ </svg>;
            ...
            {selectedEvent ? <>
                ...
                <div className="event-content" >
                    <span className='close-event-content' onClick={handleCloseEvent} >
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6"> /* SVG path */ </svg>
                    </span>
