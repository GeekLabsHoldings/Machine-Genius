...
const FootagePreview = ()=>{
    ...
    return(
        <div className={`w-full h-full flex flex-col py-[4vh] ${styles.footagePreview}`}>
<div className='flex gap-[2vw] h-[77vh] '>
            ...
            <div className="w-1/2 flex flex-col gap-[1vw]">
              ...
              <div className="flex gap-[0.6vw]">
                <div className={`${styles.box} h-[12vh] w-1/3`} onClick={(e)=>{console.log(e.target)}}>
              ...
              <div className='flex'>
              <h5>URL:</h5>
              <a href="https://www.youtube.com/watch?v=jfKfPfyJRdk">https://www.youtube.com/watch?v=jfKfPfyJRdk</a>
              </div>
              </div>
