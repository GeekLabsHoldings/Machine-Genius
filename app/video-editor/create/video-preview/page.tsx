    ...
    return(
        <div className={`w-full h-full py-[1vw] pageHeader `}>
              <h3 className='pb-[0.8vw]'>Your video is all done!</h3>
                ...
                {/* edit boxes */}
                        <div className={`${styles.access} w-1/3 ps-[2vw] flex flex-col gap-[0.8vw]`}>
                            <h4>Quick Acss</h4>
                            <div className={`${styles.box}`}>
                                ...
                                <CustomBtn width='w-full' word='Footage Selection' href='/video-editor/create/footage-preview' btnColor='black'/>
                            </div>

                            <div className={`${styles.box}`}>
                                <h5>Edit Music</h5>
                                <p>Make sure to watch the video carefully before uploading, if there are any errors in your video, you can quick edit them from the options below </p>
                                <CustomBtn width='w-full' word='Music Selection' href='/video-editor/create/converted-article' btnColor='black'/>
                            </div>

                            <div className={`${styles.box}`}>
                                <h5>Voice Over</h5>
                                <p>Make sure to watch the video carefully before uploading, if there are any errors in your video, you can quick edit them from the options below </p>
                                <CustomBtn width='w-full' word='Voice Over' href='/video-editor/create/converted-article' btnColor='black'/>
                            </div>
