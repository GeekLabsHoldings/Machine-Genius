...
const Page = () => {
    ...
    const handleEditCard = (e: any) => {
        ...
        $(`.${styles.card}`).not($(e.target).parents(`.${styles.card}`)).addClass(styles.disabled)
    ...
    return (
        <div className="flex flex-col h-full">
            ...
            <div className={"flex flex-col h-[75vh] py-[1.5vw] " + styles.view_template_wrapper}>
                <div className="flex items-center justify-between gap-[2vw] mb-[1.5vw]">
                    <h5>Video Editor Template</h5>
                    {Iseditable ? <CustomBtn btnColor='black' word='Save & Exit' paddingVal='px-[1.5vw] py-[0.5vw]' onClick={() => setIseditable(false)} /> : <CustomBtn btnColor='white' icon={editIcon} word='Modify Template' paddingVal='px-[1.5vw] py-[0.5vw]' onClick={() => setIseditable(true)} />}
                </div>
                ...
                <div className="grid grid-cols-2 gap-[1.5vw] h-full overflow-auto">
                    <div className=' space-y-[1.5vw]'>
                        <div className='grid grid-cols-2 gap-[1.5vw]'>
                            <div className={styles.card}>
                                <div className={styles.card_header}>
                                    <h6>Job Position</h6>
                                    {Iseditable && <button onClick={e => handleEditCard(e)}><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                                ...
                                <div className={styles.card_actions}>
                                    ...
                                    <CustomBtn btnColor='black' word='Save' onClick={e => handleSaveCard(e)} />
                                </div>
                            </div>
                            <div className={styles.card}>
                                <div className={styles.card_header}>
                        ...
                        <div className={styles.card}>
                            ...
                            <div className={styles.card_body}>
                                <ul>
                                    <li>Edit and enhance video footage to create engaging content.</li>
                                    <li>Collaborate with team members to meet project requirements and deadlines.</li>
                                    <li>Stay updated on industry trends and techniques to improve editing skills.</li>
                                    <li>Contribute creative ideas to enhance the overall quality of video content.</li>
                                </ul>
                            </div>
                            <div className={styles.card_actions}>
                                <CustomBtn btnColor='white' word='Delete Card' />
                    ...
                    <div className='space-y-[1.5vw]'>
                        <div className={styles.card}>
                            ...
                            <div className={styles.card_body}>
                                <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Illo dolorem a assumenda quis temporibus asperiores.</p>
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Illum, quo neque. Ipsum odio animi eaque ullam facilis. Voluptatem, pariatur omnis.</p>
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Perferendis, porro vel ratione accusantium aspernatur velit cumque necessitatibus dolores enim consequatur unde deserunt maxime nulla? Doloribus.</p>
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Perferendis, porro vel ratione accusantium aspernatur velit cumque necessitatibus dolores enim consequatur unde deserunt maxime nulla? Doloribus.</p>
                            </div>
                            <div className={styles.card_actions}>
                                <CustomBtn btnColor='white' word='Delete Card' />
            ...
            {Iseditable && <div className="flex justify-end items-center w-full gap-[1vw]">
                <CustomBtn
                    word="Add Card"
                    btnColor="white"
                    icon={addIcon}
