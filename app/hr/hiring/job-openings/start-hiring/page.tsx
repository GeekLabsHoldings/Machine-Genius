        ...
        <div className={styles.templatePreviewContainer + " w-[60%] "}>
          ...
          <div className="space-y-6">
            ...
            <div className="border border-[#2A2B2A] rounded-[11px] px-[1.25vw] py-[1.5vw] bg-[#DBDBD73D]">
              ...
              {/* Job Description */}
              <div>
                <span className="font-bold mb-[10px] block">
                  Job Description:
                </span>
                <p>
                  As a Video Editor at [Company Name], you will be responsible
                  for transforming raw footage into polished and captivating
                  video content.
                  <br />
                  <br />
                  Working closely with our creative team, you will edit and
                  enhance video footage to create compelling narratives that
                  align with our brand identity and meet the highest standards
                  of quality.
                  <br />
                  <br />
                  You will collaborate with producers, directors, and other team
                  members to understand project requirements and deliver on
                  creative vision.
                  <br />
                  <br />
