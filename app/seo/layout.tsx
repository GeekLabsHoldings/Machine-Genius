...
const layout = ({ children }: Readonly<{ children: React.ReactNode; }>) => {
  ...
  const sideNavLinks = [
    {
      name: "Dashboard", path: "/seo/dashboard", icon: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="none">
    ...
    {
      name: "Keyword Research", path: "/seo/keyword-research", icon: <svg xmlns="http://www.w3.org/2000/svg" width="22" height="21" viewBox="0 0 22 21" fill="none">
    ...
    {
      name: "Keyword Database", path: "/seo/keyword-database", icon: <svg xmlns="http://www.w3.org/2000/svg" width="22" height="21" viewBox="0 0 22 21" fill="none">
    ...
    {
      name: "Link Building", path: "/seo/link-building", icon: <svg xmlns="http://www.w3.org/2000/svg" width="22" height="21" viewBox="0 0 22 21" fill="none">
    ...
    {
      name: "Affiliates Database", path: "/seo/affiliates-database", icon: <svg xmlns="http://www.w3.org/2000/svg" width="22" height="21" viewBox="0 0 22 21" fill="none">
    ...
    {
      name: "Website Audit", path: "/seo/website-audit", icon: <svg xmlns="http://www.w3.org/2000/svg" width="22" height="21" viewBox="0 0 22 21" fill="none">
